...
namespace OpenKHS.Universal.ViewModels
{
    ...
    public class ViewModelLocator
    {
        ...
        public TalksViewModel TalksViewModel => SimpleIoc.Default.GetInstance<TalksViewModel>();

        public PublicViewModel PublicViewModel => SimpleIoc.Default.GetInstance<PublicViewModel>();
